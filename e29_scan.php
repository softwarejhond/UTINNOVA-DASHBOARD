...
<div style="margin-top: 50px;">
    <div class="mt-3">
        ...
        <div id="dashboard">
            <div class="position-relative bg-transparent pb-1">
                <img src="img/logo_cedulink.png" alt="CeduLink Logo" class="position-absolute top-4 start-0" style="height: 60px;">
            </div>
            <br><br>
            <hr>
            <?php include("components/scanDocs/tableVery.php"); ?>
            <div class="row">
