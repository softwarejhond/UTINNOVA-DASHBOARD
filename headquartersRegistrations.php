    ...
    <div class="mt-3">
        ...
        <div id="dashboard">
            <div class="position-relative bg-transparent">
                <h2 class="position-absolute top-4 start-0"><i class="bi bi-building-fill-gear"></i> Administrar sedes con pre-registros</h2>
            </div>
            <br><br>
            <hr>
            <?php include("components/headquarters/listHeadquartersResgistrations.php"); ?>
            <div class="row">
