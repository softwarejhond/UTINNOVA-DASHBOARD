...
<div style="margin-top: 50px;">
    <div class="mt-3">
        ...
        <div id="dashboard">
            ...
            <h2 class="position-absolute top-4 start-0"><i class=" fas fa-tools"></i> Administración de PQRS</h2>
            </div>
            <br><br>
            <hr>
            <?php include("components/pqr/listPQRS.php"); ?>
            <div class="row">
        ...
        $(document).ready(function() {
            $('#tablaPQRS').DataTable({
                "language": {
                    ...
                    "searchPlaceholder": "Buscar por radicado..."
                }
            });
        });
    </script>
    <script>
        $(document).ready(function() {
            $('.modal[id^="editarPQRModal-"]').on('shown.bs.modal', function(event) {
                ...
                var pqrId = document.querySelector(`#${modalId} #pqrId`).value;
                console.log('ID de la PQR (desde JavaScript):', pqrId);
            });
        });
    </script>
