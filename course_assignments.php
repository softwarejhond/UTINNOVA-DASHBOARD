    ...
    <div class="mt-3">
        ...
        <div id="dashboard">
            <div class="position-relative bg-transparent">
                <h2 class="position-absolute top-4 start-0"><i class="bi bi-journal-code"></i> Asinación de cursos a estudiantes</h2>
            </div>
            <br><br>
            <hr>
            <?php include("components/courseAssignments/table_assignments.php"); ?>
            <div class="row">
