    ...
    <div class="mt-3">
        ...
        <div id="dashboard">
            <div class="position-relative bg-transparent">
                <h2 class="position-absolute top-4 start-0"><i class="fa-solid fa-graduation-cap"></i> Estudiantes por aprobar</h2>
            </div>
            <br><br>
            <hr>
            <?php include("components/to_approve/list_approve.php"); ?>
            <div class="row">
