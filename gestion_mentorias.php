...
/**
 * ============================================
 * Registro de asistencias a masterclass y nivelaciones (asistenciaNivelacion.php)
 * ============================================
 * Este componente permite registrar y visualizar la asistencia de usuarios a sesiones de masterclass y nivelaciones.
 * Verifica la sesión y el rol del usuario antes de mostrar la información.
 * Integra componentes para mostrar códigos QR, tarjetas de asistencia y filtros.
 * Utiliza DataTables y Bootstrap para la visualización dinámica y responsiva.
 * El diseño es claro y facilita la gestión rápida de asistencias por parte de los responsables.
 */
...
<head>
    ...
    <link rel="icon" href="img/uttInnova.png" type="image/x-icon"></head>
    ...
    <div class="mt-3">
        ...
        <div id="dashboard">
            <div class="position-relative bg-transparent">
                <h2 class="position-absolute top-4 start-0"><i class="bi bi-file-easel-fill"></i> Gestion de mentorias</h2>
            </div>
            <br><br>
            <hr>
            <?php include("components/qrMentorias/codes_cards.php"); ?>
            <div class="row">
