    ...
    <div class="mt-3">
        ...
        <div id="dashboard">
            <div class="position-relative bg-transparent">
                <h2 class="position-absolute top-4 start-0"><i class="bi bi-person-fill-exclamation"></i> Seguimiento de campistas</h2>
            </div>
            <br><br>
            <hr>
            <?php include("components/registration_traking/list_traking.php"); ?>
            <div class="row">
