    ...
    <div class="mt-3">
        ...
        <div id="dashboard">
            <div class="position-relative bg-transparent">
                <h2 class="position-absolute top-4 start-0"><i class="bi bi-award-fill"></i> Estudiantes con diploma</h2>
            </div>
            <br><br>
            <hr>
            <?php include("components/certificateTable/table_certificate.php"); ?>
            <div class="row">
