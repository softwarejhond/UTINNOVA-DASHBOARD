    ...
    <div class="mt-3">
        ...
        <div id="dashboard">
            <div class="position-relative bg-transparent">
                <h2 class="position-absolute top-4 start-0"><i class="fa-solid fa-file-contract"></i> Roles y radicados</h2>
            </div>
            <br><br>
            <hr>
            <?php include("components/rolesAndContracts/roleTabs.php"); ?>
            <div class="row">
