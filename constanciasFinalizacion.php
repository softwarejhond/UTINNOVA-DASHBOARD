    ...
    <div class="mt-3">
        ...
        <div id="dashboard">
            <div class="position-relative bg-transparent">
                <h2 class="position-absolute top-4 start-0"><i class="fa-solid fa-user-graduate"></i> Generar constancia de finalización</h2>
            </div>
            <br><br>
            <hr>
            <?php include("components/certCompletion/recordsTabs.php"); ?>
            <div class="row">
