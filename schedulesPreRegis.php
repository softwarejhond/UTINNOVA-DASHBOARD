    ...
    <div class="mt-3">
        ...
        <div id="dashboard">
            <div class="position-relative bg-transparent">
                <h2 class="position-absolute top-4 start-0"><i class="bi bi-alarm"></i> Horarios de sedes de pre-registro</h2>
            </div>
            <br><br>
            <hr>
            <?php include("components/listSchedules/table_schedulesRegis.php"); ?>
            <div class="row">
