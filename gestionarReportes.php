    ...
    <div class="mt-3">
        ...
        <div id="dashboard">
            <div class="position-relative bg-transparent">
                <h2 class="position-absolute top-4 start-0"><i class="bi bi-flag-fill"></i> Gestionar reportes sobre campistas</h2>
            </div>
            <br><br>
            <hr>
            <?php include("components/studentsReports/reportsTable.php"); ?>
            <div class="row">
