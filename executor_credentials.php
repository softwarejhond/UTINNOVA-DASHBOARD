    ...
    <div class="mt-3">
        ...
        <div id="dashboard">
            <div class="position-relative bg-transparent">
                <h2 class="position-absolute top-4 start-0"><i class="fa-solid fa-id-card-clip"></i> Generar o descargar carnet a ejecutores</h2>
            </div>
            <br><br>
            <hr>
            <?php include("components/listCredentials/executor_credentials_table.php"); ?>
            <div class="row">
...
<script>
    $(document).ready(function() {
        ...
        var table = $('#listaEjecutores').DataTable({
            responsive: true,
            language: {
