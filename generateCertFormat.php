    ...
    <div class="mt-3">
        ...
        <div id="dashboard">
            <div class="position-relative bg-transparent">
                <h2 class="position-absolute top-4 start-0"><i class="bi bi-file-earmark-medical"></i> Generar modelo de certificación</h2>
            </div>
            <br><br>
            <hr>
            <?php include("components/certificateModel/certFormat.php"); ?>
            <div class="row">
