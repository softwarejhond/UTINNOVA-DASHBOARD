                ...
                <div class="card-body d-flex flex-column">
                    ...
                    <div class="mt-3">
                        <h5 class="mb-1 font-weight-bold text-black text-center">
                            Total: <span id="totalBootcampsLoteDos" class="badge badge-primary">0</span> matriculados
                        </h5>
                        <div class="progress progress-sm h-5 mt-2">
                            <div id="progress-bar-bootcamps-lote2" class="progress-bar bg-primary" role="progressbar" style="width: 75%;" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100"></div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-4 mb-3">
                    <div class="card h-100">
                        <div class="card-body"><span class="corner corner-warning"></span>
                            <div class="d-flex mb-0">
                                <h3 class="card-title text-black "><b><i class="bi bi-person-slash"></i> Total de No Válidos Lote 2</b>
                                    <h><br><br>
                                        <h4 class="mb-1 font-weight-bold text-black"><b id="total_no_validos_lote2">0</b> | <b id="porc_no_validos_lote2"></b>%</h4>
                                        <p class="mb-2 text-xs text-muted"><i class="bi bi-person-slash"></i> <span class="opacity-75">
                                                Usuarios del Lote 2 No válidos según Interventoría</span></p>
                                        <div class="progress progress-sm h-5 mt-2 mb-3">
                                            <div id="progress-bar-no-validos-lote2" class="progress-bar bg-warning" role="progressbar" style="width: 0%;" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100"></div>
                                        </div>
                                        <h6 class="p-0">
                                            <span id="current-time"></span>
                                            <small class="text-muted text-xs ml-1">Hora actual</small>
                            ...
                            <div>
                                <h3 class="card-title text-black">
                                    <b>
                                        ...
                                        <button id="openModalSedeLoteDos" type="button" class="btn btn-link p-0 ml-2 text-danger" style="font-size: 1.2rem; cursor: pointer;" title="Ver detalle por sede">
                                            <i class="fa-solid fa-building fa-beat"></i>
                                        </button>
                                    </b>
                                </h3>
                                <h4 class="mb-1 font-weight-bold text-black"><b id="cantidadSedeLoteDos">0</b></h4>
                                <p class="mb-2 text-xs text-muted">
                                    <i class="fa fa-arrow-circle-up text-danger"></i>
                                    <span class="opacity-75">Estudiantes inscritos por sede (Lote 2)</span>
                                </p>
                                <div class="progress progress-sm h-5 mt-2 mb-3">
                                    <div class="progress-bar bg-danger" role="progressbar" style="width: 75%;" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100"></div>
                                </div>
                            ...
                            <div>
                                <h3 class="card-title text-black">
                                    <b>
                                        ...
                                        <button id="openModalSedeMatriculadosLoteDos" type="button" class="btn btn-link p-0 ml-2 text-danger" style="font-size: 1.2rem; cursor: pointer;" title="Ver detalle por sede">
                                            <i class="fa-solid fa-building fa-beat"></i>
                                        </button>
                                    </b>
                                </h3>
                                <h4 class="mb-1 font-weight-bold text-black"><b id="cantidadSedeMatriculadosLoteDos">0</b></h4>
                                <p class="mb-2 text-xs text-muted">
                                    <i class="fa fa-arrow-circle-up text-danger"></i>
                                    <span class="opacity-75">Estudiantes matriculados por sede (Lote 2)</span>
                                </p>
                                <div class="progress progress-sm h-5 mt-2 mb-3">
                                    <div class="progress-bar bg-danger" role="progressbar" style="width: 75%;" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100"></div>
                                </div>
...
<script>
    document.addEventListener('DOMContentLoaded', async () => {
        const openModal = document.getElementById('openModalSedeMatriculadosLoteDos');
        const cantidadSede = document.getElementById('cantidadSedeMatriculadosLoteDos');
        ...
        openModal.addEventListener('click', async () => {
            ...
            Swal.fire({
                title: 'Cargando...',
                text: 'Obteniendo datos de matriculados por sede',
            ...
            try {
                ...
                const sedes = datos.sedesMatriculadosLote2;
                ...
                await Swal.fire({
                    title: 'Matriculados por sede (Lote 2)',
                    html: listHtml,
                    showCancelButton: true,
                    showConfirmButton: false,
...
<script>
    document.addEventListener('DOMContentLoaded', async () => {
        const openModal = document.getElementById('openModalSedeLoteDos');
        const cantidadSede = document.getElementById('cantidadSedeLoteDos');
        const progressBar = document.querySelector('#page-2 .progress-bar.bg-danger');
        ...
        openModal.addEventListener('click', async () => {
            ...
            Swal.fire({
                title: 'Cargando...',
                text: 'Obteniendo datos de inscritos por sede',
                allowOutsideClick: false,
                allowEscapeKey: false,
                showConfirmButton: false,
                didOpen: () => {
            ...
            try {
                ...
                // Cerrar loader y mostrar datos
                await Swal.fire({
                    title: 'Inscritos por sede (Lote 2)',
                    html: listHtml,
                    showCancelButton: true,
                    showConfirmButton: false,
                    cancelButtonText: 'Cerrar',
...
<script>
    document.addEventListener('DOMContentLoaded', async () => {
        const openModal = document.getElementById('openModalBootcampsLoteDos');
        const bootcampList = document.getElementById('bootcampListLoteDos');
        const totalBootcamps = document.getElementById('totalBootcampsLoteDos');
