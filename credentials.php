    ...
    <div class="mt-3">
        ...
        <div id="dashboard">
            <div class="position-relative bg-transparent">
                <h2 class="position-absolute top-4 start-0"><i class="bi bi-person-badge"></i> Generar o descargar carnet</h2>
            </div>
            <br><br>
            <hr>
            <?php include("components/listCredentials/credentials_table.php"); ?>
            <div class="row">
