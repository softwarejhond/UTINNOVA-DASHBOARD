...
<head>
    ...
    <link rel="icon" href="img/img/uttInnova.png" type="image/x-icon">
</head>
    ...
    <div class="mt-3">
        ...
        <div id="dashboard">
            <div class="position-relative bg-transparent">
                <h2 class="position-absolute top-4 start-0"><i class="bi bi-calendar-range"></i> Periodos de los Bootcamps</h2>
            </div>
            <br><br>
            <hr>
            <?php include("components/bootcampPeriods/periods_table.php"); ?>
            <div class="row">
