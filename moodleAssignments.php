    ...
    <div class="mt-3">
        ...
        <div id="dashboard">
            <div class="position-relative bg-transparent">
                <h2 class="position-absolute top-4 start-0"><i class="bi bi-robot"></i> Registrar pre-asignados en Moodle</h2>
            </div>
            <br><br>
            <hr>
            <?php include("components/registerMoodle/multiplePreAssignments.php"); ?>
            <div class="row">
...
$(document).ready(function () {
    ...
    var table = $('#listaInscritos').DataTable({
        ...
        pagingType: "simple",
        columnDefs: [
            { orderable: false, targets: [6] } // Desactivar ordenación en la columna 5 (checkbox)
        ],
